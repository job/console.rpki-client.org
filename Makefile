all:
	...
	install /usr/lib/libpthread.so.* /usr/lib/libexpat.so.* /usr/lib/libtls.so.* /usr/lib/libssl.so.* /usr/lib/libcrypto.so.* /usr/lib/libutil.so.* /usr/lib/libz.so.* /usr/lib/libc.so.* /var/www/usr/lib/
